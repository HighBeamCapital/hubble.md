...
describe("desktop moveSidebarItem", () => {
	...
	it("moves multiple files sequentially", async () => {
		const api = createDesktopApi();
		api.listDirectory
			.mockResolvedValueOnce({
				files: [
					{ path: "/workspace/archive/a.md", modified_at: 2 },
			...
			.mockResolvedValueOnce({
				files: [
					{ path: "/workspace/archive/a.md", modified_at: 2 },
					{ path: "/workspace/archive/b.md", modified_at: 2 },
					{ path: "/workspace/archive/existing.md", modified_at: 1 },
				],
				folders: [],
			});
		const { appStore, moveSidebarItems } = await loadStoreActions(api);
		...
		await moveSidebarItems(
			[
				{ kind: "file", path: "/workspace/a.md" },
				{ kind: "file", path: "/workspace/b.md" },
			],
			"/workspace/archive",
		);
		...
		expect(api.renameFile).toHaveBeenNthCalledWith(
			1,
			"/workspace/a.md",
			"/workspace/archive/a.md",
		);
		expect(api.renameFile).toHaveBeenNthCalledWith(
			2,
			"/workspace/b.md",
			"/workspace/archive/b.md",
		);
	});

	it("moves mixed file and folder selections through the existing move behavior", async () => {
		const api = createDesktopApi();
		api.listDirectory
			.mockResolvedValueOnce({
				files: [
					{ path: "/workspace/archive/client/brief.md", modified_at: 2 },
					{ path: "/workspace/todo.md", modified_at: 1 },
					{ path: "/workspace/archive/keep.md", modified_at: 1 },
				],
				folders: [
					{ path: "/workspace/archive", modified_at: 1 },
					{ path: "/workspace/archive/client", modified_at: 2 },
				],
			})
			.mockResolvedValueOnce({
				files: [
					{ path: "/workspace/archive/client/brief.md", modified_at: 2 },
					{ path: "/workspace/archive/todo.md", modified_at: 2 },
					{ path: "/workspace/archive/keep.md", modified_at: 1 },
				],
				folders: [
					{ path: "/workspace/archive", modified_at: 1 },
		...
		const { appStore, moveSidebarItems, viewerStore, workspaceStore } =
			await loadStoreActions(api);
		...
		appStore.set((current) => ({
			...
			workspace: {
				...
				folders: [
					{ path: "/workspace/client", modified_at: 1 },
					{ path: "/workspace/archive", modified_at: 1 },
				],
				pinnedNotes: ["/workspace/client/brief.md", "/workspace/todo.md"],
				lastOpenedPaths: { "/workspace": "/workspace/client/brief.md" },
			},
			document: {
				...current.document,
				currentPath: "/workspace/client/brief.md",
		...
		await moveSidebarItems(
			[
				{ kind: "folder", folderId: "client/" },
				{ kind: "file", path: "/workspace/todo.md" },
			],
			"/workspace/archive",
		);
		...
		expect(api.renameFile).toHaveBeenCalledWith(
			"/workspace/client",
			"/workspace/archive/client",
		);
		expect(api.renameFile).toHaveBeenCalledWith(
			"/workspace/todo.md",
			"/workspace/archive/todo.md",
		);
		expect(viewerStore.get().currentPath).toBe(
			"/workspace/archive/client/brief.md",
		);
		expect(workspaceStore.get().pinnedNotes).toEqual([
			"/workspace/archive/client/brief.md",
			"/workspace/archive/todo.md",
	...
	it("skips invalid descendant folder moves", async () => {
		const api = createDesktopApi();
		const { appStore, moveSidebarItems } = await loadStoreActions(api);
		...
		appStore.set((current) => ({
			...
			workspace: {
				...current.workspace,
				workspacePath: "/workspace",
				files: [{ path: "/workspace/project/note.md", modified_at: 1 }],
				folders: [
					{ path: "/workspace/project", modified_at: 1 },
					{ path: "/workspace/project/archive", modified_at: 1 },
				],
			},
		}));
